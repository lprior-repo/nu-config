...
# =============================================================================
# Complete AWS Authentication System with SSO, profiles, and credential management
...
def --env hd-login [
    ...
    if $sso {
        aws-login $hd_profile --sso
    } else if $temp {
        aws-login $hd_profile --temp
    } else {
        aws-login $hd_profile
    }
